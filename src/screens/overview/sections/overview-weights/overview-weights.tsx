...
export const OverviewWeights = () => {
    ...
    const { overviewData, overviewWeightsChartData, overviewDataLoding } = useSelector((state: AppState) => state.overview);
    ...
    const selectChartData = (unit: ChartUnit) => {
        if(!guardians) return
        const data = getWeightsChartData(guardians, unit, overviewData);
